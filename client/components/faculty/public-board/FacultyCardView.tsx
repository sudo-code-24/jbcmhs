...
export function FacultyCardView({
  ...
  const principalPanelId = "faculty-principal-panel";
  const principalHeaderId = "faculty-principal-header";
        ...
        <section className="scroll-mt-4" aria-label="Principal">
          ...
          >
            <div className="min-h-0 overflow-hidden">
              <div className="mx-auto flex flex-col items-center gap-2 pt-2 md:w-[calc(30%)] sm:w-full">
