    ...
    return (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M12 22a2.5 2.5 0 0 0 2.5-2.5v-6a2.5 2.5 0 1 0-5 0v6A2.5 2.5 0 0 0 12 22Z"
        />
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M18 8a6 6 0 1 0-12 0v5l-2 3h16l-2-3V8Z"
        />
      </svg>
    );
  };
        ...
        <div className="container-wide flex flex-wrap items-center gap-x-4 gap-y-3 py-4">
          <div className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-base font-bold leading-none text-primary">
                {DEFAULT_SCHOOL_INFO.name}
              </p>
              <p className="truncate text-xs text-muted-foreground">
                {DEFAULT_SCHOOL_INFO.tagline}
              </p>
            </div>
          </div>
